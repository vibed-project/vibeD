...
```yaml
image: { repository: ghcr.io/vibed-project/vibed, tag: "v0.6.0", pullPolicy: IfNotPresent }
controller: { image: { tag: "v0.6.0" }, domain: apps.example.com }
router:     { image: { tag: "v0.6.0" } }
